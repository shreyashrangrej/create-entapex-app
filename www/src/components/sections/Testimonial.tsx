const Testimonial = () => {
  return (
    <section className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-11">
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        ...
        <div className="mt-6 lg:mt-10">
          <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
            <svg
              className="absolute top-0 left-0 transform -translate-x-8 -translate-y-8 h-16 w-16 text-gray-200 sm:h-24 sm:w-24 dark:text-gray-700"
              width="16"
              height="13"
              viewBox="0 0 16 13"
              fill="none"
            ...
            <span className="relative z-10 italic text-gray-800 dark:text-gray-200">
              This stack has everything you need for a full-stack web
              application. From authentication to database. From typescript to
              tailwind.
            </span>
          </p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="text-sm text-gray-500">Web Dev | EntApex</div>
        </div>
      </blockquote>
    </section>
  );
